<header class="main-header">
    ...
    <a href="{{route('dashboard')}}" class="logo">
        ...
        <span class="logo-mini"><img src="../../ntg/Amarica.jpeg" class="img-circle" style="width: 50px"></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="../../ntg/Amarica.jpeg" class="img-circle" style="width: 50px"><b>Audio Play</b></span>
    </a>
